...
class RawData():
    ...
    def saveRawData(self):
        ...
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'sensor', self.sensor)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'petID', self.petID)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'time', self.time)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'girX', self.girX)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'girY', self.girY)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'girZ', self.girZ)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'accX', self.accX)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'accY', self.accY)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'accZ', self.accZ)
        firebase.put('RawDog/'+CurrentDate()+'/'+TransformationHour(self.time), 'HR', self.HR)
...
class ReadRawData():
    ...
    def Read(self):        
        ...
        #SensorRawData = firebase.get('RawData2/', CurrentDate())
        ##codigo para teste
        ...
        #for que pega somente o tempo de cada dicionario
        for hour in obj.values():
            timeKey = hour['time']
            raw_data_hour.append(timeKey)
